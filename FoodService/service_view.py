...
class ServiceViews(generics.ListAPIView):
    queryset = Service.objects.except_soft_delete()
    serializer_class = ServiceSerializers


class ServiceCreateViews(generics.CreateAPIView):
    queryset = Service.objects.all()
    serializer_class = ServiceSerializers


class ServiceEditViews(generics.UpdateAPIView):
    queryset = Service.objects.all()
    serializer_class = ServiceSerializers
    lookup_field = 'id'


class ServiceSoftDeleteViews(APIView):
